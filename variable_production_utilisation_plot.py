...
last_day_of_simulation = 2000
sensitivity_variable_array = [
  0.1111111 * diesel_production_capacity_hp,
  0.125 * diesel_production_capacity_hp,
  0.1428571 * diesel_production_capacity_hp,
  0.1666666 * diesel_production_capacity_hp,
  0.2 * diesel_production_capacity_hp,
  0.25 * diesel_production_capacity_hp,
  0.3333333 * diesel_production_capacity_hp,
  0.5 * diesel_production_capacity_hp,
  diesel_production_capacity_hp
  ]

pprint.pprint(sensitivity_variable_array)
...
for index in range(len(sensitivity_variable_array)):
  diesel_production_capacity_hp = sensitivity_variable_array[index]
  # State variables
...
plt.plot(time, diesel_reserves_delay_9, label=f"Current Production Utilitisation", linewidth=3.0)
plt.plot(time, diesel_reserves_delay_8, label=f"Two Times Production Utilisation", linewidth=3.0)
plt.plot(time, diesel_reserves_delay_7, label=f"Three Times Production Utilisation", linewidth=3.0)
plt.plot(time, diesel_reserves_delay_6, label=f"Four Times Production Utilisation", linewidth=3.0)
plt.plot(time, diesel_reserves_delay_5, label=f"Five Times Production Utilisation", linewidth=3.0)
plt.plot(time, diesel_reserves_delay_4, label=f"Six Times Production Utilisation", linewidth=3.0)
plt.plot(time, diesel_reserves_delay_3, label=f"Seven Times Production Utilisation", linewidth=3.0)
plt.plot(time, diesel_reserves_delay_2, label=f"Eight Times Production Utilisation", linewidth=3.0)
plt.plot(time, diesel_reserves_delay_1, label=f"Nine Times Production Utilisation", linewidth=3.0)
...
plt.savefig('variable_production_utilisation.tiff', dpi=500, bbox_inches='tight')
