...
simulation_output = [[
  0, 
  0, 
  0.25 * initial_diesel_reserve, 
  0.5 * initial_diesel_reserve, 
  0.75 * initial_diesel_reserve, 
  initial_diesel_reserve, 
  1.25 * initial_diesel_reserve, 
  1.5 * initial_diesel_reserve, 
  1.75 * initial_diesel_reserve, 
  2 * initial_diesel_reserve]]
...
for index in range(len(simulation_output[0]) - 1):
  # State variables
...
# plt.plot(time, diesel_reserves_delay_1, label="No Diesel Reserves", linewidth=3.0)
# plt.plot(time, diesel_reserves_delay_2, label="25% of Current Diesel Reserves", linewidth=3.0)
plt.plot(time, diesel_reserves_delay_3, label="50% of Current Diesel Reserves", linewidth=3.0)
plt.plot(time, diesel_reserves_delay_4, label="75% of Current Diesel Reserves", linewidth=3.0)
plt.plot(time, diesel_reserves_delay_5, label="Current Diesel Reserves Levels", linewidth=3.0)
plt.plot(time, diesel_reserves_delay_6, label="125% of Current Diesel Reserves", linewidth=3.0)
plt.plot(time, diesel_reserves_delay_7, label="150% of Current Diesel Reserves", linewidth=3.0)
plt.plot(time, diesel_reserves_delay_8, label="175% of Current Diesel Reserves", linewidth=3.0)
plt.plot(time, diesel_reserves_delay_9, label="200% of Current Diesel Reserves", linewidth=3.0)
simulation_output = [[
  0, 
  0, 
  0.25 * initial_diesel_reserve, 
...
plt.savefig('plot_variable_diesel_reserve.tiff', dpi=500, bbox_inches='tight')
