...
sensitivity_variable_array = [0, 30, 60, 90, 120, 150, 180, 210, 240]
...
for index in range(len(sensitivity_variable_array)):
  initial_delay = sensitivity_variable_array[index]
  # State variables
...
plt.plot(time, diesel_reserves_delay_1, label=f"{sensitivity_variable_array[0]} day delay", linewidth=3.0)
plt.plot(time, diesel_reserves_delay_2, label=f"{sensitivity_variable_array[1]} day delay", linewidth=3.0)
plt.plot(time, diesel_reserves_delay_3, label=f"{sensitivity_variable_array[2]} day delay", linewidth=3.0)
plt.plot(time, diesel_reserves_delay_4, label=f"{sensitivity_variable_array[3]} day delay", linewidth=3.0)
plt.plot(time, diesel_reserves_delay_5, label=f"{sensitivity_variable_array[4]} day delay", linewidth=3.0)
plt.plot(time, diesel_reserves_delay_6, label=f"{sensitivity_variable_array[5]} day delay", linewidth=3.0)
plt.plot(time, diesel_reserves_delay_7, label=f"{sensitivity_variable_array[6]} day delay", linewidth=3.0)
plt.plot(time, diesel_reserves_delay_8, label=f"{sensitivity_variable_array[7]} day delay", linewidth=3.0)
plt.plot(time, diesel_reserves_delay_9, label=f"{sensitivity_variable_array[8]} day delay", linewidth=3.0)
...
plt.savefig('plot_variable_delay.tiff', dpi=500, bbox_inches='tight')
